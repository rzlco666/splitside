...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public');?>/assets/css/chartist.css">
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('public');?>/assets/css/vector-map.css">
<!-- Plugins css Ends-->
<!-- Bootstrap css-->
