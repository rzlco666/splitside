...
<header class="main-nav">
	<div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a>
		...
		<?php else: ?>
		<img class="img-90 rounded-circle" style="object-fit: cover; width: 70px; height: 90px;" src="<?= base_url('assets/uploads/images/foto_profil/'.$userdata->photo); ?>" alt="">
		<?php endif; ?>

		<div class="badge-bottom"><span class="badge badge-primary">Online</span></div><a href="user-profile.html">
			<h6 class="mt-3 f-14 f-w-600"><?= $userdata->first_name; ?> <?= $userdata->last_name; ?></h6></a>
		<p class="mb-0 font-roboto">Member</p>
		<ul>
