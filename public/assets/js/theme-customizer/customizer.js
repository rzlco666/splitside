...
$('<div class="customizer-links"> ' +
	...
	'<div class="settings"><i class="icofont icofont-laptop-alt"></i></div>' +
	'<span>Check Layout</span> </a> <a class="nav-link" id="c-pills-home-tab" data-bs-toggle="pill" href="#c-pills-home"> ' +
	'<div class="settings"><i class="icofont icofont-ui-settings"></i></div><span>Sidebar Type</span> </a> ' +
	'<a class="nav-link" id="c-pills-home-tab1" data-bs-toggle="pill" href="#c-pills-profile"> ' +
	'<div class="settings color-settings"><i class="icofont icofont-color-bucket"></i></div><span>Color Picker</span> </a> </div>' +
